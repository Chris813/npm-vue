<template>
  <div class="app">
    <splitpanes class="splitpanes">
      <pane min-size="70" key="left">
        <div class="header">
          <svg width="30" height="30" viewBox="0 0 114 114" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <el-icon v-if="showRight" size="30" class="toggle" @click="handlePanel">
            <i-ep-caret-right />
          </el-icon>
      ...
      <pane v-if="showRight" size="20" key="right">
        <InfoList />
      </pane>
    </splitpanes>
  </div>
...
.splitpanes {
  ...
  &__pane {
    box-shadow: 0 0 5px rgba(241, 225, 225, 0.22) inset;
    padding: 1vw;
